...
NOTICE:
    ...
    Packages you need to have: Pandas, Numpy, Requests, BeautifulSoup, Os, Glob, Time, Math, Re.

    This program support [ test ] and [ official ] version for both [ windows ] and [ linux/mac ] users.
    [ test ] version contains the same function of official one, but only download small amount of data.
    [ official ] version will download all the information from 2014 to 2020, but it will cost you about [ 24 hrs or more ] to finish the whole process.
    If you just want to verify the function of this program, I highly recommend you to use [ test ] version.


------------------------------------------------------------------Auto-Working Instructions------------------------------------------------------------------------------------------------------------------------

If you need this program work automatically, the ONLY thing you need to do is: Open [ start_scrapping.py ], and change 'year_list' to the year(s) you want, then run it.
